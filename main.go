...
func main() {
	...
	layerAnalyser := layer.NewLayerAnalyser()
	extractor := extract.NewExtractor(imageRepo, manifestParser, imageConfigParser, layerAnalyser)
	...
	app.Commands = []cli.Command{
		...
		},
		{
			...
			Flags: []cli.Flag{
				...
				cli.BoolFlag{
					Name:  "strip-pax, p",
					Usage: "Strip vendor-specific PAX headers from output layer tar",
				},
			},
		},
	}
